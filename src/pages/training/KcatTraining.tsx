...
const KcatTraining: React.FC = () => {
  ...
  const breadcrumbItems = [
    ...
    {
      name: t('features.kcat.train.title'),
      path: '/training/kcat',
      color: mainColor,
    }
  ];
    ...
    <Form onSubmit={handleSubmit}>
      ...
      <Form.Group className="mb-4">
        ...
        <Form.Text className="text-muted">
          {t('training.form.supportedFormats')}
          <a href="/sample/kcat_training_template.csv" download>{t('training.form.downloadTemplate')}</a>
        </Form.Text>
      </Form.Group>
  ...
  const renderSuccess = () => (
    <Alert variant="success">
      ...
      <p>
        {t('training.form.successMessage', { jobId: jobId })}
      </p>
      <p>
  ...
  return (
    <PredictorLayout
      title={t('features.kcat.train.titleEn')}
        ...
        <Col lg={4}>
          <Card className="shadow-sm mb-4">
            <Card.Body>
              ...
              <p>
                {t('training.form.kcatDatasetRequirement')}
              </p>
              <ul>
                <li><strong>protein_sequence</strong> - {t('training.form.kcatRequiredColumn.protein')}</li>
                <li><strong>substrate_smiles</strong> - {t('training.form.kcatRequiredColumn.substrate')}</li>
                <li><strong>kcat_value</strong> - {t('training.form.kcatRequiredColumn.kcatValue')}</li>
              </ul>

...
const KmTraining: React.FC = () => {
  ...
  const breadcrumbItems = [
    ...
    {
      name: t('features.km.title') + ' ' + t('features.km.titleSuffix'),
      path: '/features/km',
      color: mainColor,
    },
    {
      name: t('features.km.train.title'),
      path: '/training/km',
      color: mainColor,
    }
  ];
    ...
    <Form onSubmit={handleSubmit}>
      ...
      <Form.Group className="mb-4">
        ...
        <Form.Text className="text-muted">
          {t('training.form.kmSupportedFormats')}
          <a href="/sample/km_training_template.csv" download>{t('training.form.downloadTemplate')}</a>
        </Form.Text>
      </Form.Group>
  ...
  const renderSuccess = () => (
    <Alert variant="success">
      ...
      <p>
        {t('training.form.kmSuccessMessage', { jobId: jobId })}
      </p>
      <p>
  ...
  return (
    <PredictorLayout
      title={t('features.km.train.titleEn')}
        ...
        <Col lg={4}>
          <Card className="shadow-sm mb-4">
            <Card.Body>
              ...
              <p>
                {t('training.form.kmDatasetRequirement')}
              </p>
              <ul>
                <li><strong>protein_sequence</strong> - {t('training.form.kmRequiredColumn.protein')}</li>
                <li><strong>substrate_smiles</strong> - {t('training.form.kmRequiredColumn.substrate')}</li>
                <li><strong>km_value</strong> - {t('training.form.kmRequiredColumn.kmValue')}</li>
              </ul>

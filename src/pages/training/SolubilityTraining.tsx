...
const SolubilityTraining: React.FC = () => {
  ...
  const breadcrumbItems = [
    ...
    {
      name: t('home.protein.solubility.title') + " " + t('features.train'),
      path: '/training/solubility',
      color: mainColor,
    }
  ];
    ...
    <Form onSubmit={handleSubmit}>
      ...
      <Form.Group className="mb-4">
        ...
        <Form.Text className="text-muted">
          {t('training.form.solubilitySupportedFormats')}
          <a href="/sample/solubility_training_template.csv" download>{t('training.form.downloadTemplate')}</a>
        </Form.Text>
      </Form.Group>
  ...
  const renderSuccess = () => (
    <Alert variant="success">
      ...
      <p>
        {t('training.form.solubilitySuccessMessage')} <strong>{jobId}</strong>
      </p>
      <p>
  ...
  return (
    <PredictorLayout
      title={t('features.solubility.train.titleEn')}
        ...
        <Col lg={4}>
          <Card className="shadow-sm mb-4">
            <Card.Body>
              ...
              <p>
                {t('training.form.solubilityDatasetRequirement')}
              </p>
              <ul>
                <li><strong>protein_sequence</strong> - {t('training.form.solubilityRequiredColumn.protein')}</li>
                <li><strong>solubility_score</strong> - {t('training.form.solubilityRequiredColumn.score')}</li>
              </ul>
              <Alert variant="info" className="mt-3">
                <strong>{t('training.form.tip')}:</strong> {t('training.form.datasetSizeRecommendation')}
              </Alert>
            </Card.Body>
          </Card>
...
export default SolubilityTraining; 